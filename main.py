...
def evidently_dashboard(report):
    ...
    project.dashboard.add_panel(
        text_panel(title="Rock vs Mine Dashboard")
    )
...
def rock_mine_pipeline(file_path='data/Sonar.csv'):
    ...
    pipeline, data = train_random_forest(X_train=X_train, X_test=X_test, y_train=y_train, y_test=y_test, data=data, output_path=data_output)
    other_data = other_data_prediction(data_path=other_data_path, pipeline=pipeline, output_path=other_data_output)
